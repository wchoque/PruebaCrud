<?php
	...
	class espaciodenombres
	{
        ...
        public $xmlnsPerception = 'urn:sunat:names:specification:ubl:peru:schema:xsd:Perception-1';
        public $xmlnsDespatchAdvice = 'urn:oasis:names:specification:ubl:schema:xsd:DespatchAdvice-2';
        ...
        public $wssecurity ='http://docs.oasis-open.org/wss/2004/01/oasis-200401-wss-wssecurity-secext-1.0.xsd';
        ...
        public $nodoResponseCode = '/ar:ApplicationResponse/cac:DocumentResponse/cac:Response/cbc:ResponseCode';
        public $nodoDescription ='/ar:ApplicationResponse/cac:DocumentResponse/cac:Response/cbc:Description';
	}	
