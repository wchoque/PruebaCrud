...
class DebitNoteCore
{
	...
	public function DebitNote()
    {
		...
		$writer->writeAttribute('xmlns','urn:oasis:names:specification:ubl:schema:xsd:DebitNote-2');
		...
		$writer->writeElementNS('cbc','DocumentCurrencyCode', null,$UblVersionId);
			...
			//Código del tipo de nota de bbito electrónica
			...
			$writer->startElementNS('cac','DebitNoteDocumentReference',null);
