  ...
  var app = new Vue({
    ...
    data: function() {
      return {
        ...
        correntista:{pais:null,departamento:null,provincia:null,distrito:null,
          ...
          apellidos:'',nombre_comercial:'',notas:'',extranjero:0,id_corren:0,ubigeo_id_ubigeo:0,tipdoc_id_tipdoc:0,distribuidor:0,fecha_nacimiento:'',estado_civil:'',genero:''},
        correntistas: {},
        contactos: {},
        contacto: {},
        cuentas: {},
    ...
    methods: {
      ...
      todosClientes: function() {
        params = {};
        this.$http.get(root + "/obtener-clientes").then(function(_response) {
      ...
      guardarCliente: function(_evt) {
       ...
       // this.correntista.fecha_nacimiento='2017-12-12 22:58:16';
      ...
      obtenerCliente: function(_correntista, _evt) {
        params = {id_corren:_correntista};
        this.$http
            .post(root + "/obtener-cliente", params)
            .then(function(_response) {
              if(_response.data.status.code=='PROCESS_COMPLETE'){
                ...
                this.correntista.codigo=_response.data.data.cliente[0].codigo;
                ...
                this.correntista.distribuidor=_response.data.data.distribuidor;
