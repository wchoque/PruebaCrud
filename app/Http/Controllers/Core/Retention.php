...
use zipxml\zipxmls;
		...
		$writer->writeAttribute('xmlns',$obj->xmlnsRetention);
		...
		$writer->writeElementNS('sac','SUNATRetentionSystemCode', null,'04');
		$writer->writeElementNS('sac','SUNATRetentionPercent', null,'04');
		...
		$writer->startElementNS('sac','SUNATTotalPaid', null);
		$writer->writeAttribute('currencyID','02');
		$writer->text('F100-10');
		$writer->endElement();
		...
		//for
		$writer->startElementNS('sac','SUNATRetentionDocumentReference',null);
		...
		$writer->startElementNS('sac','SUNATRetentionInformation',null);
		$writer->startElementNS('sac','SUNATRetentionAmount', null);
		$writer->writeAttribute('currencyID','6');
		$writer->text('20549202960');
		$writer->endElement();
		$writer->writeElementNS('sac','SUNATRetentionDate', null,'04');
		$writer->startElementNS('sac','SUNATNetTotalPaid', null);
		$writer->writeAttribute('currencyID','6');
		$writer->text('20549202960');
		$writer->endElement();
